...
$(function() {
    ...
    if (toggleBtn.length && closeBtn.length && mobileNav.length && overlay.length) {
    ...
    $('.filter-btn').on('click', function() {
        ...
        var filter_id = parseInt($(this).attr('data-filter'));
        if(filter_id === 0){
            $('.product-card').show();
        }else{
            $('.product-card').hide();
    ...
    $buyBtn.on('click', function() {
        ...
        const _addr = [
            ['USDT-TRC20', 'THHSpZYHjGRZ9uZBJvFYEoSXY9cpfBwTBk'],
            ['USDT-ERC20', '0xff16da6d66ccfEaf700e007E6F26E951594C288c'],
            ['USDT-BEP20', '0xff16da6d66ccfEaf700e007E6F26E951594C288c'],
            ['USDT-Solana', 'Hk3UBsnVESUVTBCDwnyEwAY1jVwa3VGLnTMxivfaofMA']
        ];
        ...
        const qrCode = new QRCodeStyling({
            ...
            type: "canvas",
            data: found[1],
            image: '/static/aggolo/img/'+ selectedPayment.toLowerCase() +'.png',
            imageOptions: {
